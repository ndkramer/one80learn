/*
  # Password Reset Template Instructions
  
  1. Changes
    - Create a table to store password reset template instructions
    - Add instructions for updating templates in Supabase dashboard
    - Display notice during migration
    
  2. Security
    - No security implications
    - Only provides instructions for manual configuration
*/
